    ...
    <form action="" method="POST" enctype="multipart/form-data" name="article_form">
      <div>
        ...
        <div class="row">
          <div class="col">
            <div class="form-group">
              <input type="text" name="tags" id="tags" placeholder="Tags" value="<?php echo sizeof($current_article)>0?$current_article["tags"]:""?>" required>
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="form-group">
          <textarea name="body" rows="8" cols="80" maxlength="50000" style="display:none;" required></textarea>
